...
3. install GPIO package: pip install RPi.GPIO (use this!)
4. pip install requests (for http requests)
...
4. sudo systemctl enable letterbox.service
...
3. sudo systemctl enable powerswitch.service
